...
export function buildAssetCountBySection(assets: AssetDefinitionMetadata[]): AssetCountsResult {
      ...
      (
        {
          groupMetadata: {
            ...
            repositoryLocationName: repositoryLocationNameA,
            repositoryName: repositoryNameA,
          },
        },
        {
          groupMetadata: {
            groupName: groupNameB,
            repositoryLocationName: repositoryLocationNameB,
            repositoryName: repositoryNameB,
          },
        },
      ) =>
        COMMON_COLLATOR.compare(repositoryLocationNameA, repositoryLocationNameB) ||
        COMMON_COLLATOR.compare(repositoryNameA, repositoryNameB) ||
        COMMON_COLLATOR.compare(groupNameA, groupNameB),
    );
  const countPerCodeLocation = Object.entries(assetCountByCodeLocation)
    ...
    .sort(
      (
        {repoAddress: {name: nameA, location: locationA}},
        {repoAddress: {name: nameB, location: locationB}},
      ) => COMMON_COLLATOR.compare(locationA, locationB) || COMMON_COLLATOR.compare(nameA, nameB),
    );
